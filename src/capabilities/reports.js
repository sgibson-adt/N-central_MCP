...
export async function runReport(args) {
  switch (args.reportType) {
    case 'patch-comparison':
      ...
      return createCapabilityResult(await getReport(args.reportId), ['GET /api/report/{reportId}']);
    case 'device-filters':
      return createCapabilityResult(await listDeviceFilters(args), ['GET /api/device-filters']);
    default:
