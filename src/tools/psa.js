...
export const psaTools = Object.freeze([
  ...
  D('list_psa_companies', 'List Standard PSA companies for one customer. Returns integrationStatus=unavailable with an empty list when N-central reports the integration unavailable.', { customerId }, ['customerId'], ['GET /api/standard-psa/customers/{customerId}/companies'], 'read', (a) => psa.listPsaCompanies(a.customerId)),
