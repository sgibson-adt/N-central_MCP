...
The reviewed 87-name inventory contains 53 retained, 32 consolidated/deprecated, and 2 removed names.
...
| `clear_device_notes` | consolidated | `delete_device_notes` | `clear_device_notes` | Delegates to delete_device_notes; inputs and results follow its curated contract. |
| `create_access_group` | retained | `create_access_group` | `create_access_group` | No contract change. |
| `create_custom_psa_ticket` | consolidated | `create_psa_ticket` | `create_custom_psa_ticket` | Delegates to create_psa_ticket; inputs and results follow its curated contract. |
...
| `create_direct_scheduled_task` | consolidated | `create_scheduled_task` | `create_direct_scheduled_task` | Delegates to create_scheduled_task; inputs and results follow its curated contract. |
...
| `get_custom_psa_ticket_detail` | consolidated | `get_psa_ticket` | `get_custom_psa_ticket_detail` | Delegates to get_psa_ticket; inputs and results follow its curated contract. |
| `get_customer` | consolidated | `get_organization_context` | `get_customer` | Delegates to get_organization_context; inputs and results follow its curated contract. |
| `get_device` | consolidated | `get_device_context` | `get_device` | Delegates to get_device_context; inputs and results follow its curated contract. |
| `get_device_activation_key` | retained | `get_device_activation_key` | `get_device_activation_key` | No contract change. |
| `get_device_assets` | consolidated | `get_device_context` | `get_device_assets` | Delegates to get_device_context; inputs and results follow its curated contract. |
...
| `get_device_lifecycle` | consolidated | `get_device_context` | `get_device_lifecycle` | Delegates to get_device_context; inputs and results follow its curated contract. |
| `get_device_status` | consolidated | `get_device_context` | `get_device_status` | Delegates to get_device_context; inputs and results follow its curated contract. |
| `get_maintenance_windows` | consolidated | `get_device_context` | `get_maintenance_windows` | Delegates to get_device_context; inputs and results follow its curated contract. |
...
| `get_org_unit` | consolidated | `get_organization_context` | `get_org_unit` | Delegates to get_organization_context; inputs and results follow its curated contract. |
...
| `get_report` | consolidated | `run_report` | `get_report` | Delegates to run_report; inputs and results follow its curated contract. |
| `get_scheduled_task` | consolidated | `get_scheduled_task_context` | `get_scheduled_task` | Delegates to get_scheduled_task_context; inputs and results follow its curated contract. |
| `get_scheduled_task_status` | consolidated | `get_scheduled_task_context` | `get_scheduled_task_status` | Delegates to get_scheduled_task_context; inputs and results follow its curated contract. |
| `get_server_info` | consolidated | `get_server_status` | `get_server_info` | Delegates to get_server_status; inputs and results follow its curated contract. |
...
| `get_server_time` | consolidated | `get_server_status` | `get_server_time` | Delegates to get_server_status; inputs and results follow its curated contract. |
| `get_service_org` | consolidated | `get_organization_context` | `get_service_org` | Delegates to get_organization_context; inputs and results follow its curated contract. |
| `get_site` | consolidated | `get_organization_context` | `get_site` | Delegates to get_organization_context; inputs and results follow its curated contract. |
...
| `list_all_users` | consolidated | `list_users` | `list_all_users` | Delegates to list_users; inputs and results follow its curated contract. |
| `list_custom_psa_tickets` | consolidated | `search_psa_tickets` | `list_custom_psa_tickets` | Delegates to search_psa_tickets; inputs and results follow its curated contract. |
| `list_customers` | consolidated | `search_organizations` | `list_customers` | Delegates to search_organizations; inputs and results follow its curated contract. |
...
| `list_device_notes` | consolidated | `get_device_context` | `list_device_notes` | Delegates to get_device_context; inputs and results follow its curated contract. |
| `list_device_tasks` | consolidated | `list_device_scheduled_tasks` | `list_device_tasks` | Delegates to list_device_scheduled_tasks; inputs and results follow its curated contract. |
| `list_devices` | consolidated | `search_devices` | `list_devices` | Delegates to search_devices; inputs and results follow its curated contract. |
| `list_devices_by_org_unit` | consolidated | `search_devices` | `list_devices_by_org_unit` | Delegates to search_devices; inputs and results follow its curated contract. |
...
| `list_org_unit_children` | consolidated | `get_organization_context` | `list_org_unit_children` | Delegates to get_organization_context; inputs and results follow its curated contract. |
| `list_org_units` | consolidated | `search_organizations` | `list_org_units` | Delegates to search_organizations; inputs and results follow its curated contract. |
...
| `list_scheduled_tasks` | consolidated | `list_device_scheduled_tasks` | `list_scheduled_tasks` | Delegates to list_device_scheduled_tasks; inputs and results follow its curated contract. |
| `list_service_orgs` | consolidated | `search_organizations` | `list_service_orgs` | Delegates to search_organizations; inputs and results follow its curated contract. |
| `list_sites` | consolidated | `search_organizations` | `list_sites` | Delegates to search_organizations; inputs and results follow its curated contract. |
...
| `report_all_users_by_so` | consolidated | `report_all_users_by_service_org` | `report_all_users_by_so` | Delegates to report_all_users_by_service_org; inputs and results follow its curated contract. |
...
| `report_devices_by_so` | consolidated | `report_devices_by_service_org` | `report_devices_by_so` | Delegates to report_devices_by_service_org; inputs and results follow its curated contract. |
